                    ...
                    <form action="{{ route('pizza.store') }}" method="post" enctype="multipart/form-data"> @csrf
                        <div class="card-body">
                            ...
                            <div class="form-inline">
                                ...
                                <input name="small_pizza_price" type="number" class="form-control"
                                    placeholder="small pizza price">
                                <input name="medium_pizza_price" type="number" class="form-control"
                                    placeholder="medium pizza price">
                                <input name="large_pizza_price" type="number" class="form-control"
